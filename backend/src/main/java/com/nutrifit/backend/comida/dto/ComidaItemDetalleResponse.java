...
/**
 * DTO enriquecido para devolver el detalle nutricional de un item de comida.
 */
public class ComidaItemDetalleResponse {
    ...
    public ComidaItemDetalleResponse() {
    }
    ...
    public ComidaItemDetalleResponse(
            ...
            String nombre,
            double gramos,
            double kcalEstimadas,
            double proteinasEstimadas,
            double grasasEstimadas,
            double carbosEstimados
    ) {
        this.itemId = itemId;

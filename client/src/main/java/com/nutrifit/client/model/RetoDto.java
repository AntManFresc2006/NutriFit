...
public class RetoDto {
    ...
    public RetoDto(Long id, String titulo, String descripcion, String tipo, int metaValor, int duracionDias, int puntos, String icono, Long usuarioRetoId, Integer progreso, boolean aceptado, boolean completado, LocalDate fechaFin) {
        this.id = id;
        this.titulo = titulo;
